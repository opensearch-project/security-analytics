 ...
 */
public class OneFiftyRules2KDocsEndurance extends Simulation {

    Map.Entry<Integer, Integer> EXECUTIONS_DOCRATE = Map.entry(150, 2000);
...

    {
        ...
        setUp(scn.injectOpen(CoreDsl.constantUsersPerSec(CONCURRENT_USERS).during(Duration.ofMinutes(1))))
                .throttle(
                        ...
                        CoreDsl.holdFor(Duration.ofDays(3))
