...
public class SigmaEndswithModifier extends SigmaValueModifier {

    public SigmaEndswithModifier(SigmaDetectionItem detectionItem, List<Class<? extends SigmaModifier>> appliedModifiers) {
