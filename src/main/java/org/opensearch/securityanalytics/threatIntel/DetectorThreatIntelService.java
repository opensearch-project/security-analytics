...
public class DetectorThreatIntelService {
    ...
    public DetectorThreatIntelService(ThreatIntelService threatIntelService, Client client, NamedXContentRegistry xContentRegistry) {
    ...
    public void createDocLevelQueryFromThreatIntel(List<LogType.IocFields> iocFieldList, Detector detector, ActionListener<List<DocLevelQuery>> listener) {
        try {
            ...
            threatIntelService.getThreatIntelFeedData(new ActionListener<>() {
                @Override
