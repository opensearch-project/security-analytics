...
public class ThreatIntelMonitorActions {
    ...
    public static final String GET_THREAT_INTEL_ALERTS_ACTION_NAME = "cluster:admin/security_analytics/threatIntel/alerts/get";
    public static final String UPDATE_THREAT_INTEL_ALERT_STATUS_ACTION_NAME = "cluster:admin/security_analytics/threatIntel/alerts/status/update";
}
