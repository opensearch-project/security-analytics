...
//                "root", true
//        );
//        SearchSourceBuilder metadataSearchSourceBuilder = new SearchSourceBuilder();
//        metadataSearchSourceBuilder.query(matchQueryBuilder);
//        metadataSearchSourceBuilder.fetchSource(true);
//        metadataSearchSourceBuilder.size(1);
//        SearchRequest metadataSearchRequest = new SearchRequest();
//        metadataSearchRequest.indices(CorrelationIndices.CORRELATION_METADATA_INDEX);
//        metadataSearchRequest.source(metadataSearchSourceBuilder);
//        metadataSearchRequest.preference(Preference.PRIMARY_FIRST.type());
//
//        client.search(metadataSearchRequest, ActionListener.wrap(response -> {
...
//            }
//
//            Map<String, Object> metadataHitSource = response.getHits().getHits()[0].getSourceAsMap();
//            long counter = Long.parseLong(metadataHitSource.get("counter").toString());
//
...
//                            correlateFindingAction.onFailures(new OpenSearchStatusException("Correlation of findings failed", RestStatus.INTERNAL_SERVER_ERROR));
//                        }
...
//                                            correlateFindingAction.onOperation();
//                                        } else {
//                                            throw new OpenSearchStatusException(indexResponse.toString(), RestStatus.INTERNAL_SERVER_ERROR);
//                                        }
//                                    }, this::onFailure));
