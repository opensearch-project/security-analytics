...
public class SecurityAnalyticsPlugin extends Plugin implements ActionPlugin, MapperPlugin, SearchPlugin, EnginePlugin, ClusterPlugin, SystemIndexPlugin, JobSchedulerExtension, RemoteMonitorRunnerExtension {
    ...
    public List<Setting<?>> getSettings() {
        return List.of(
                ...
                SecurityAnalyticsSettings.BATCH_AUTO_CORRELATIONS_TIMEBOX,
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        return List.of(
                ...
                new ActionPlugin.ActionHandler<>(AlertingActions.SUBSCRIBE_BATCH_FINDINGS_ACTION_TYPE, TransportCorrelateFindingAction.class),
