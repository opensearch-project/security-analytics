...
public class TransporSearchCorrelationRuleAction extends HandledTransportAction<SearchCorrelationRuleRequest, SearchResponse> {

    private static final Logger log = LogManager.getLogger(TransporSearchCorrelationRuleAction.class);
    ...
    @Inject
    public TransporSearchCorrelationRuleAction(
