...
public class RuleIndices {
    ...
    private void ingestQueries(Map<String, List<String>> logIndexToRules, WriteRequest.RefreshPolicy refreshPolicy, TimeValue indexTimeout, ActionListener<BulkResponse> listener) throws SigmaError, IOException, SigmaErrorList {
    ...
    private List<Rule> getQueries(QueryBackend backend, String category, List<String> rules) throws SigmaError, SigmaErrorList {
        List<Rule> queries = new ArrayList<>();
            ...
            public void onResponse(Void unused) {
                ...
                client.search(searchRequest, new ActionListener<>() {
                    ...
                    public void onResponse(SearchResponse response) {
                        ...
                        } catch (SigmaError | IOException | SigmaErrorList e) {
                            onFailure(e);
                        }
                    }
