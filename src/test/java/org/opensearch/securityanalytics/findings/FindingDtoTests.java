...
public class FindingDtoTests extends OpenSearchTestCase {
    ...
    public void testFindingDTO_creation() {
        ...
        FindingDto findingDto = new FindingDto(
                ...
                "my_index",
                List.of(new DocLevelQuery("1", "myQuery", "fieldA:valABC", Collections.emptyList(), List.of())),
                now,
        ...
        assertEquals(List.of(new DocLevelQuery("1", "myQuery", "fieldA:valABC", Collections.emptyList(), List.of())), findingDto.getDocLevelQueries());
