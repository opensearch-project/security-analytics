...
import static org.opensearch.securityanalytics.TestHelpers.windowsDetectorType;
...
public class AlertsIT extends SecurityAnalyticsRestTestCase {
    ...
    public void testGetAlerts_byDetectorType_multipleDetectorTypes_success() throws IOException, InterruptedException {
        ...
        createMappingRequest.setJsonEntity(
            "{ \"index_name\":\"" + index + "\"," +
                "  \"rule_topic\":\"" + windowsDetectorType() + "\", " +
                "  \"partial\":true" +
                "}"
        );
        ...
        Detector detector = randomDetectorWithTriggers(input, List.of(new DetectorTrigger(null, "test-trigger", "1", List.of(windowsDetectorType(), randomDetectorType()), List.of(), List.of(), List.of(), List.of())));
        ...
        assertEquals(5, getAlertsBody.get("total_alerts"));
        ...
        // TODO enable asserts here when able
        // 5 prepackaged rule matches for 5 documents + 1 custom doc rule + 1 custom bucket rule
        Assert.assertEquals(7, getAlertsBody.get("total_alerts"));
    }
    ...
    public void testGetAlertsFromAllIndicesMultipleDetectorTypes() throws IOException, InterruptedException {
        ...
        Map<String, Object> getAlertsBody = asMap(getAlertsResponse);
        // TODO enable asserts here when able
        assertEquals("Number of total alerts for windows category not correct", 4, getAlertsBody.get("total_alerts"));
        ...
        getAlertsBody = asMap(getAlertsResponse);
        // TODO enable asserts here when able
        Assert.assertEquals("Number of total alerts for test_windows category not correct", 6, getAlertsBody.get("total_alerts"));
        /** TODO - uncomment once https://github.com/opensearch-project/alerting/pull/753 is merged
        alerts = (ArrayList<Map<String, Object>>) getAlertsBody.get("alerts");
        ...
        assertEquals("Number of alerts not correct", 9, getAlertsBody.get("total_alerts"));**/
    }
}