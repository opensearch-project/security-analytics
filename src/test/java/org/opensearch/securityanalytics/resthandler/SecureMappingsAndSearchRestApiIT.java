...
public class SecureMappingsAndSearchRestApiIT extends SecurityAnalyticsRestTestCase {
    ...
    public void setup() throws IOException {
        ...
        readOnlyClient = new SecureRestClientBuilder(
                getClusterHosts().toArray(new HttpHost[]{}), isHttps(), readOnlyUser, readOnlyUser
    ...
    public void cleanup() throws IOException {
        ...
        client().performRequest(new Request("DELETE", "/" + SENSITIVE_INDEX));
    }
