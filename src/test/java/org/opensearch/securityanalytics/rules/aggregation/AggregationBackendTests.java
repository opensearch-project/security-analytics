...
public class AggregationBackendTests extends OpenSearchTestCase {
    ...
    public void testCountAggregation() throws SigmaError, IOException, SigmaErrorList {
    ...
    public void testCountAggregationWithGroupBy() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
                "            title: Test\n" +
                        "            id: 39f919f3-980b-4e6f-a975-8af7e507ef2b\n" +
    ...
    public void testSumAggregationWithGroupBy() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
                "            title: Test\n" +
                        "            id: 39f919f3-980b-4e6f-a975-8af7e507ef2b\n" +
    ...
    public void testMinAggregationWithGroupBy() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
                "            title: Test\n" +
                        "            id: 39f919f3-980b-4e6f-a975-8af7e507ef2b\n" +
    ...
    public void testMaxAggregationWithGroupBy() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
                "            title: Test\n" +
                        "            id: 39f919f3-980b-4e6f-a975-8af7e507ef2b\n" +
    ...
    public void testAvgAggregationWithGroupBy() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
                "            title: Test\n" +
                        "            id: 39f919f3-980b-4e6f-a975-8af7e507ef2b\n" +
    ...
    public void testCloudtrailAggregationRule() throws IOException, SigmaErrorList, SigmaError {
    ...
    public void testCloudtrailAggregationRuleWithDotFields() throws IOException, SigmaErrorList, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(Map.of(), true, true);
        List<Object> queries = queryBackend.convertRule(SigmaRule.fromYaml(
