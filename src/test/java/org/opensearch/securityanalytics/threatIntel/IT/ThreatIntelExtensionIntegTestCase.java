...
public class ThreatIntelExtensionIntegTestCase extends OpenSearchRestTestCase {

//    protected Datasource createWatcherJob(String jobId, Datasource jobParameter) throws IOException {
...
//    protected Datasource createWatcherJobWithClient(RestClient client, String jobId, Datasource jobParameter)
//            throws IOException {
...
//    }
    ...
    protected Map<String, String> getJobParameterAsMap(String jobId, Datasource jobParameter) throws IOException {
...
//    protected Datasource getJobParameter(RestClient client, String jobId) throws IOException {
//        Request request = new Request("POST", "/" + SecurityAnalyticsPlugin.JOB_INDEX_NAME + "/_search");
//        String entity = "{\n"
//                + "    \"query\": {\n"
//                + "        \"match\": {\n"
//                + "            \"_id\": {\n"
...
//    }
    ...
    protected void waitAndCreateWatcherJob(String jobId, Datasource jobParameter) {
