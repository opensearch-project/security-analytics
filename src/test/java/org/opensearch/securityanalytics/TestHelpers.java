...
public class TestHelpers {
    ...
    public static Detector randomDetector(String name,
        ...
        return new Detector(null, null, name, enabled, schedule, lastUpdateTime, enabledTime, detectorType, user, inputs, triggers, Collections.singletonList(""), "", "", "", "", "", "", Collections.emptyMap(), detectorType.getDetectorType());
    }
    ...
    public static Detector randomDetectorWithNoUser() {
        ...
        return new Detector(null, null, name, enabled, schedule, lastUpdateTime, enabledTime, detectorType, null, inputs, Collections.emptyList(),Collections.singletonList(""), "", "", "", "", "", "", Collections.emptyMap(), "test_windows");
    }
