...
public class SATIFSourceConfigTests extends OpenSearchTestCase {
    ...
    private void assertEqualsSaTifSourceConfigs(SATIFSourceConfig saTifSourceConfig, SATIFSourceConfig newSaTifSourceConfig) {
        ...
        assertEquals(saTifSourceConfig.getSchedule().getStartTime().toEpochMilli(), newSaTifSourceConfig.getSchedule().getStartTime().toEpochMilli());
        assertEquals(saTifSourceConfig.getSchedule().getInterval(), newSaTifSourceConfig.getSchedule().getInterval());
        assertEquals(saTifSourceConfig.getSchedule().getUnit(), newSaTifSourceConfig.getSchedule().getUnit());
        ...
        assertEquals(iocStoreConfig.getIocMapStore().keySet(), newIocStoreConfig.getIocMapStore().keySet());
