...
public class SATIFSourceConfigDtoTests extends OpenSearchTestCase {
    ...
    private void assertEqualsSaTifSourceConfigDtos(SATIFSourceConfigDto saTifSourceConfigDto, SATIFSourceConfigDto newSaTifSourceConfigDto) {
        ...
        assertEquals(saTifSourceConfigDto.getSchedule().getStartTime().toEpochMilli(), newSaTifSourceConfigDto.getSchedule().getStartTime().toEpochMilli());
        assertEquals(saTifSourceConfigDto.getSchedule().getInterval(), newSaTifSourceConfigDto.getSchedule().getInterval());
        assertEquals(saTifSourceConfigDto.getSchedule().getUnit(), newSaTifSourceConfigDto.getSchedule().getUnit());
